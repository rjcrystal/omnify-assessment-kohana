...
<div class="container">
    <div class="row">
        <div class="col mt-5">
                ...
                <?php if(empty($events)){?>
                    <h4>No upcoming events found in your calendar.</h4>
                <?php } else {
                    echo "<span>Your calender events are as follows</span><br>";
                    foreach($events as $event)
                    {
                        echo View::factory('EventCard')->set('details',$event->as_array());
                    }
                 }?>
        </div>
    </div>
